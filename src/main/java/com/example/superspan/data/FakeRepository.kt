...
object FakeRepository {
    ...
    // Candidature fittizie per l'Area Admin
    val applications = listOf(
        JobApplication(1, "Mario Rossi", "Cassiere", "20/05/2024", false),
        JobApplication(2, "Anna Bianchi", "Scaffalista", "21/05/2024", true),
        JobApplication(3, "Luigi Verdi", "Magazziniere", "22/05/2024", true)
    )
}